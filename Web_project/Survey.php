                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navLinks">
                            ...
                            <ul class="navbar-nav ms-auto flex-wrap">
                                ...
                                <li class="nav-item"><a class="nav-link" href="Questionnaire.html">Questionnaire page</a></li>
                                <li class="nav-item"><a class="nav-link" href="calculate.html">calculate page</a></li>
                        ...
                        <div class="card-body p-4">
                            ...
                            <form action="https://httpbin.org/get" method="get">
                                ...
                                <section class="mb-4">
                                    ...
                                    <p>Your college:</p>
                                    <div class="ms-3">
                                        <label><input type="radio" name="college" value="Science"> College of Science</label><br>
                                        <label><input type="radio" name="college" value="Engineering"> College of Engineering</label><br>
                                        <label><input type="radio" name="college" value="Education"> College of Education</label><br>
                                        <label><input type="radio" name="college" value="Nursing"> College of Nursing</label><br>
                                        <label><input type="radio" name="college" value="Medicine"> College of Medicine & Health Sciences</label><br>
                                        <label><input type="radio" name="college" value="Arts"> College of Arts & Social Sciences</label><br>
                                ...
                                <section class="mb-4">
                                    ...
                                    <div class="ms-3">
                                        ...
                                        <label><input type="radio" name="freq" value="Few times a week"> A few times a week</label><br>
                                ...
                                <section class="mb-4">
                                    ...
                                    <div class="ms-3">
                                        ...
                                        <label><input type="radio" name="food" value="Vegetarian"> Vegetarian food</label><br>
                                    ...
                                    <textarea rows="5" class="form-control" name="suggestions" placeholder="Your suggestions..."></textarea>
